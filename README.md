...
Eventually, I got a powerful new PC. Ironically, it was then that I lost interest in gaming. I realized that what truly fascinated me wasn’t the entertainment - it was the process. The control.

Later, I discovered Python. That was a turning point.

Since then, I’ve spent thousands of hours honing my skills - building web scrapers, APIs, Telegram bots, automation scripts, and entire backend services. I dove deep into frameworks like Django and FastAPI, mastered tools like Docker, Redis, PostgreSQL, Celery, and Git, and fell in love with building systems that solve real problems.
